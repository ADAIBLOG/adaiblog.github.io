...
(() => {
    ...
    // ============== 配置区域 ============== //
    const _0x1a2b = ['\x67\x6d\x61\x69\x6c\x2\x63\x6f\x6d', '\x67\x69\x74\x68\x75\x62\x2\x69\x6f']; // 合法域名白名单（明文混淆）
    const _0x34df = ['\x59\x32\x31\x79\x6d\x35\x68\x62\x57\x56\x66\x62\x33\x42\x33']; // 主站域名哈希校验值（SHA-256）
